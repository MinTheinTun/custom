...
if(isset($_POST['register_button'])) {
    ...
    if ($_FILES['image']['error'] === 4) {
        ...
        if (!in_array($imageExtension, $validImageExtension)) {
            ...
            $query = "INSERT INTO senior(name,dob,gender,nrc,image,phone,address,email)VALUES('$name','$dob','$gender','$nrc','$newImageName','$phone','$address','$email')";
...
<section id="contact">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="text-center">Senior Registration Form</h4>
                <div class="row justify-content-center my-5">
                    <div class="col-lg-6">
                        <form action="senior_register.php" method="POST" enctype="multipart/form-data">
