    ...
    <div class="sidebar">
        ...
        <div class="logo">
            ...
            <ul class="menu">
                ...
                <li>
                    <a href="senior.php"><i class="fa-solid fa-person-cane fa-lg"></i><span>Senior</span></a>
                </li>

                <li>
                    <a href="doctor.php"><i class="fa-solid fa-user-doctor"></i><span>Doctors</span></a>
                </li>

                <li>
                    <a href="nurse.php"><i class="fa-solid fa-user-nurse"></i><span>Nurse</span></a>
                </li>


                <li class="mb-5">
                    <a href="schedule_admin.php"><i class="fa-regular fa-clipboard"></i><span>Schedule</span></a>
                </li>
...
<!--                <img src="images/admin.jpg" alt="">-->
            ...
            <form action="admin_dashboard.php" method="POST" class="logout_button">
