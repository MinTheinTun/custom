...
if(isset($_POST['register_button'])) {
    ...
    //specialty
    $query = "SELECT * FROM specialty where name='$specialty'";
    $result= mysqli_query($db, $query);
    $result = mysqli_fetch_assoc($result);
    if(!$result){
        $query = "INSERT INTO specialty(name)VALUES('$specialty')";
    ...
    //qualification
    $query = "SELECT * FROM qualification where name='$qualification'";
    $result1= mysqli_query($db, $query);
    $result1 = mysqli_fetch_assoc($result1);
    if(!$result1){
        $query = "INSERT INTO qualification(name)VALUES('$qualification')";
    ...
    if ($_FILES['image']['error'] === 4) {
        ...
        if (!in_array($imageExtension, $validImageExtension)) {
            ...
            $query = "INSERT INTO doctor(name,qualification,specialty,dob,gender,nrc,image,phone,address,email,password,confirm,role)VALUES('$name','$qualification','$specialty','$dob','$gender','$nrc','$newImageName','$phone','$address','$email','$password','$confirm','$role')";
...
<!--                        </form>-->
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center my-5">
                    <div class="col-lg-6">
                        <form action="doctor_register.php" id="form" method="POST" enctype="multipart/form-data">
