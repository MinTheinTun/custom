...
if (isset($_GET['user_id_to_update'])) {
    ...
    $query = "SELECT * FROM nurse WHERE id=$user_id_to_update";
...
//        echo "<script>alert('Image Does not Exist');</script>";
    ...
    if (!in_array($imageExtension, $validImageExtension)) {
        ...
        $query = "UPDATE nurse SET name='$name',dob='$dob',gender='$gender',nrc='$nrc',image='$newImageName',qualification='$qualification',phone='$phone',address='$address',email='$email',password='$password',confirm='$confirm',role='$role' WHERE id=$user_id";
...
<section id="contact">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="text-center">Nurse Edit Form</h4>
                <div class="row justify-content-center my-5">
                    <div class="col-lg-6">


                        <form action="nurse_edit.php" method="POST" enctype="multipart/form-data">
