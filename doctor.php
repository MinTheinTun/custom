...
if(isset($_GET['user_id_to_delete'])){
    ...
    $query = "DELETE FROM doctor WHERE id=$user_id_to_delete";

    $result = mysqli_query($db, $query);


    $query2 = "DELETE FROM schedule WHERE doctor_id=$user_id_to_delete";
...
<!--                    <button type="button" name="back_button" id="back_button" class="btn btn-success btn-sm" onclick="history.back();">Back</button>-->
                    ...
                    <form action="doctor_register.php" method="POST" class="float-end ms-2" >
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-body">
                    <h4 class="text-center" id="page">Doctor Detail Page</h4>
                    <!-- table -->
                        ...
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            foreach($results as $user) {
                                ...
                                <tr>
                                    ...
                                    <td width="2%"><img src="uploads/<?php echo $user['image']; ?>" alt=""></td>
                                    <td width="10%"><?php echo $user['name']; ?></td>
                                    <td width="15%"><?php echo $user['qualification']; ?></td>
                                    <td width="2%"><?php echo $user['specialty']; ?></td>
                                    <td width="2%"><?php echo $user['dob']; ?></td>
                                    <td width="2%"><?php echo $user['gender']; ?></td>
                                    <td width="10%"><?php echo $user['nrc']; ?></td>
                                    <td width="2%"><?php echo $user['phone']; ?></td>
                                    <td width="20%"><?php echo $user['address']; ?></td>
                                    <td width="1%"><?php echo $user['email']; ?></td>
                                    <td width="2%"><?php echo $user['role']; ?></td>
                                    <td width="2%"><div><a href="doctor_edit.php?user_id_to_update=<?php echo $user['id']; ?>" class="btn btn-primary text-center btn-sm mb-3" title="Update"><i class="fa-solid fa-pen-to-square"></i></a></div>

                                        <div><a href="doctor.php?user_id_to_delete=<?php echo $user['id']; ?>" class="btn btn-danger  text-center btn-sm" title="Delete" onclick="return confirm('Are you sure you want to delete');"><i class="fa-solid fa-trash"></i></a></div>
