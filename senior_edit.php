...
if (isset($_GET['user_id_to_update'])) {
    ...
    $query = "SELECT * FROM senior WHERE id= $user_id_to_update";
...
//        echo "<script>alert('Image Does not Exist');</script>";
    ...
    if (!in_array($imageExtension, $validImageExtension)) {
        ...
        $query = "UPDATE senior SET name='$name',dob='$dob',gender='$gender',nrc='$nrc',image='$newImageName',phone='$phone',address='$address',email='$email' WHERE id=$user_id";
...
<section id="contact">
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header mb-3 p-3">
                ...
                <div class="row">
                    ...
                    <div>
                        ...
                        <form action="senior.php" method="POST" class="float-start">
            ...
            <div class="card-body">
                <h4 class="text-center">Senior Edit Form</h4>
                <div class="row justify-content-center my-5">
                    <div class="col-lg-6">
                        ...
                        <form action="senior_edit.php" method="POST" enctype="multipart/form-data">
